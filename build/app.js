...
},{"dup":6,"individual/one-version":22}],21:[function(require,module,exports){
arguments[4][7][0].apply(exports,arguments)
},{"dup":7}],22:[function(require,module,exports){
arguments[4][8][0].apply(exports,arguments)
},{"./index.js":21,"dup":8}],23:[function(require,module,exports){
arguments[4][9][0].apply(exports,arguments)
},{"dup":9,"min-document":1}],24:[function(require,module,exports){
"use strict";
...
var _applicationstore = require('./applicationstore');
...
var _createApplicationSto = (0, _applicationstore.createApplicationStore)(_applicationReducer2.default);

var update = _createApplicationSto.update;
var subscribe = _createApplicationSto.subscribe;
var getState = _createApplicationSto.getState;

var delegate = (0, _domDelegator2.default)();

function renderTodoList() {
  var todos = arguments.length <= 0 || arguments[0] === undefined ? [] : arguments[0];

  var labels = todos.map(function (todo) {
    return (0, _vdom.hJSX)(
      'li',
      { className: 'js-todo' },
      todo
  ...
  return (0, _vdom.hJSX)(
    ...
    (0, _vdom.hJSX)('input', { type: 'text', className: 'js-new-todo-input' }),
    (0, _vdom.hJSX)(
      'button',
      { className: 'js-new-todo' },
      'Add todo'
    ),
    (0, _vdom.hJSX)(
      'ul',
...
function createTodoListApp(targetSelector) {
  var appNode = document.querySelector(targetSelector);
  var todosDOM = (0, _vdom.createVDOMNode)(appNode);

  todosDOM.render(renderTodoList());
  subscribe(function (state) {
    return todosDOM.render(renderTodoList(state.todos));
  });

  function handleNewTodo(evt) {
    evt.preventDefault();
    var newTodoInput = document.querySelector('.js-new-todo-input');
    var todoText = newTodoInput.value;

    update((0, _actions.addTodo)(todoText));
    newTodoInput.value = "";
  }
}
...
},{"./actions":49,"./applicationReducer":51,"./applicationstore":52,"./vdom":53,"dom-delegator":4}],51:[function(require,module,exports){
'use strict';
...
function createApplicationStore(reducer) {
  ...
  return { update: update, getState: getState, subscribe: subscribe };
...
exports.createVDOMNode = exports.hJSX = undefined;
...
function createVDOMNode(element) {
    ...
    function render(newTree) {
        var patches = tree ? (0, _diff2.default)(tree, newTree) : undefined;

        rootNode = patches ? (0, _patch2.default)(rootNode, patches) : firstTimeRender(newTree);
    ...
    function firstTimeRender(newTree) {
        var newTreeElement = (0, _createElement2.default)(newTree);
        element.parentNode.replaceChild(newTreeElement, element);
        return newTreeElement;
    }

    return { render: render, rootNode: rootNode };
}

function hJSX(el, props) {
    for (var _len = arguments.length, children = Array(_len > 2 ? _len - 2 : 0), _key = 2; _key < _len; _key++) {
        children[_key - 2] = arguments[_key];
    }

    return (0, _h2.default)(el, props, children);
}

exports.hJSX = hJSX;
exports.createVDOMNode = createVDOMNode;

},{"virtual-dom/create-element":16,"virtual-dom/diff":17,"virtual-dom/h":18,"virtual-dom/patch":26}]},{},[50]);
